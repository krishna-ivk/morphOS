# morphOS v1 Milestones

- [MORPHOS_V1_RELEASE_TARGET.md](MORPHOS_V1_RELEASE_TARGET.md) - release bar for turning the current `v0` proving track into a real `v1.0` release
- [MORPHOS_SPEC_BASELINE.md](MORPHOS_SPEC_BASELINE.md) - current baseline release posture and grounded production-readiness judgment
- [MORPHOS_RELEASE_READINESS_CHECKLIST.md](MORPHOS_RELEASE_READINESS_CHECKLIST.md) - short operational checklist and repo-by-repo completion estimates for the path to production

Repo-local `v1.0` requirement specs now live in each owning repo:
